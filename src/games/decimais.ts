...
export const pi = criar({
  ...
  nome: 'Casas de π',
  icone: 'π',
  resumo: 'Dez mil casas decimais, uma tecla por vez. Errou, acabou.',
...
export const euler = criar({
  ...
  nome: 'Casas de e',
  icone: 'e',
  resumo: 'A base do logaritmo natural: 2 mil casas, uma tecla por vez.',
  categoria: 'matematica',
  prefixo: '2,',
  decimais: E_DECIMAIS,
})
...
export const phi = criar({
  ...
  nome: 'Casas de φ',
  icone: 'φ',
  resumo: 'A razão áurea, (1+√5)/2, com 2 mil casas decimais.',
  categoria: 'matematica',
  prefixo: '1,',
